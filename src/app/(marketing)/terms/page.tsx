      ...
      <div className="max-w-2xl mx-auto px-5 sm:px-10 py-12">
        ...
        <div className="space-y-8 text-sm font-normal leading-relaxed text-[#4a6147]">
          ...
          <section>
            ...
            <p>Wrenlist is operated by Dominic Cushnan, a sole trader based in the United Kingdom, trading as Wrenlist. For queries about your account or this service, contact <a href="mailto:admin@wrenlist.com" className="text-[#5a7a57] underline">admin@wrenlist.com</a>. Dominic Cushnan is registered as a data controller with the UK Information Commissioner&apos;s Office.</p>
          </section>
