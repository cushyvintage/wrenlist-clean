    ...
    <div className="min-h-screen bg-[#f5f0e8]">
      ...
      <div className="bg-[#1e2e1c] px-5 sm:px-10 py-16 sm:py-20">
        <div className="max-w-2xl mx-auto">
          <div className="hero-fade-1 text-xs font-medium uppercase tracking-widest text-[#527050] mb-5">our story</div>
          <blockquote className="hero-fade-2 font-serif text-2xl sm:text-4xl font-normal text-[#f5f0e8] leading-tight mb-7">
            ...
            They kept breaking.
            <br />
            <em className="italic text-[#527050]">So I built something that wouldn&apos;t.</em>&rdquo;
          </blockquote>
          <p className="hero-fade-3 text-sm text-[#527050]">Dom Cushnan — founder, Wrenlist</p>
        </div>
      </div>
      ...
      <Reveal className="max-w-2xl mx-auto px-5 sm:px-10 py-16">
        ...
        <div className="mb-16">
          ...
          <p className="text-sm font-normal text-[#4a6147] leading-relaxed mb-4">
          ...
          <p className="text-sm font-normal text-[#4a6147] leading-relaxed">
        ...
        <div className="grid grid-cols-3 gap-0.5 bg-[rgba(61,92,58,0.14)] rounded-lg overflow-hidden mb-16">
          <div className="bg-[#ede8de] p-5 sm:p-7 text-center">
            ...
            <p className="text-xs text-[#4a6147] leading-relaxed">outside funding.<br/>Built on what it earns.</p>
          </div>
          <div className="bg-[#ede8de] p-5 sm:p-7 text-center">
            <div className="font-mono text-2xl sm:text-3xl font-medium text-[#1e2e1c] mb-1.5">1</div>
            <p className="text-xs text-[#4a6147] leading-relaxed">person who uses it<br/>every single weekend</p>
          </div>
          <div className="bg-[#ede8de] p-5 sm:p-7 text-center">
            <div className="font-mono text-2xl sm:text-3xl font-medium text-[#1e2e1c] mb-1.5">UK</div>
            <p className="text-xs text-[#4a6147] leading-relaxed">first, always.<br/>Not an afterthought.</p>
          </div>
        </div>
        ...
        <div className="bg-[#3d5c3a] rounded-lg p-6 sm:p-10 mb-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="bg-white/10 rounded p-4">
              ...
              <p className="text-xs text-white/60">The roadmap is public. Vote, suggest, watch things actually get built. <Link href="/roadmap" className="text-[#527050] underline">See the roadmap &rarr;</Link></p>
            </div>
          </div>
        </div>
        ...
        <div className="text-center">
          <p className="text-sm font-normal text-[#4a6147] mb-5">
