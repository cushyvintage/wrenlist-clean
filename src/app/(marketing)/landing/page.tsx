    ...
    <div className="min-h-screen bg-[#f5f0e8]">
      ...
      <nav className="sticky top-0 z-50 flex items-center justify-between border-b border-[rgba(61,92,58,0.12)] bg-[#f5f0e8] px-10 py-4">
        ...
        <div className="flex gap-2 items-center">
          <Link href="/login" className="border border-[rgba(61,92,58,0.2)] rounded text-xs font-normal text-[#6b7d6a] px-4 py-2 hover:bg-[#ede8de] hover:text-[#1e2e1c]">log in</Link>
          <Link href="/register" className="bg-[#3d5c3a] text-[#f5f0e8] rounded text-xs font-medium px-5 py-2 hover:bg-[#2c4428] uppercase tracking-wider">start free</Link>
        </div>
      </nav>
      ...
      <div className="grid grid-cols-2 border-b border-[rgba(61,92,58,0.12)]">
        <div className="flex flex-col justify-center px-12 py-16">
          ...
          <div className="flex gap-4 items-center">
            <Link href="/register" className="bg-[#3d5c3a] text-[#f5f0e8] px-8 py-3 text-xs font-medium uppercase tracking-widest hover:bg-[#2c4428]">
              Start free — no card needed
            </Link>
            <Link href="/dashboard" className="text-sm font-normal text-[#5a7a57] underline cursor-pointer hover:text-[#3d5c3a]">
              see the app →
            </Link>
          </div>
        </div>
