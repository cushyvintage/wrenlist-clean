...
/**
 * GET /api/chrome-extension/ebay/product-payload/[findId]
 * Fetches a Find from the platform and converts it to CrosslistProduct format
 * for the eBay extension to use directly
 */
export async function GET(
  ...
  try {
    ...
    console.error('GET /api/chrome-extension/ebay/product-payload error:', error)
    return ApiResponseHelper.internalError()
  }
}
