export const SHOPIFY_UPLOAD_IMAGE_URL = "https://shopify-staged-uploads.storage.googleapis.com/";
export const getShopifyAdminDomain = (shopId) => `https://admin.shopify.com/store/${shopId}`;
export const getShopifyGraphqlUrl = (shopId) => `https://admin.shopify.com/api/shopify/${shopId}/internal/web/graphql/core`;
