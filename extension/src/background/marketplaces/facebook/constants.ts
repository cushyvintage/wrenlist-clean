...
export const FACEBOOK_IMAGE_UPLOAD_URL =
...
export const FACEBOOK_SELLING_QUERY_NAME =
  "CometMarketplaceYouSellingFastContentContainerQuery";
export const FACEBOOK_CREATE_MUTATION_NAME =
  "useCometMarketplaceListingCreateMutation";
export const FACEBOOK_EDIT_MUTATION_NAME =
  "useCometMarketplaceListingEditMutation";
export const FACEBOOK_DELETE_MUTATION_NAME =
  "useCometMarketplaceListingDeleteMutation";
