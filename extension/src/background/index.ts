...
const DEPOP_CATEGORY_MAP: Record<string, string[]> = {
  ...
  clothing_womenswear_dresses: ["womenswear", "dresses", "dresses"],
  clothing_womenswear_tops: ["womenswear", "tops", "blouses"],
  clothing_womenswear_skirts: ["womenswear", "bottoms", "skirts"],
  clothing_womenswear_womens_coats_jackets: ["womenswear", "coats-jackets", "jackets"],
  clothing_menswear: ["menswear", "tops", "t-shirts"],
  clothing_menswear_mens_coats_jackets: ["menswear", "coats-jackets", "jackets"],
